...
//    Image logo = Toolkit.getDefaultToolkit().createImage("src/Icons/aaLogo.png");
    ImageIcon logo = new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("Icons/aaLogo.png")));
    ...
    public MenuPanel(String id) {
        ...
        playButton.setIcon(new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("Icons/play.png"))));
        System.out.println(Objects.requireNonNull(getClass().getClassLoader().getResource("Icons/play.png")));
        levelButton.setIcon(new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("Icons/levels.png"))));
    ...
    public void paintComponent(Graphics g) {
        ...
        g.drawImage(logo.getImage(), 50, 40, 300, 300, null);
//        logo, 50, 40, 300, 300, null
    }
}
